...
declare type RetrievalInfo = { PayloadCID: Cid, ID: number, PieceCID: Cid, PricePerByte: string, UnsealPrice: string, Status: number, Message: string, Provider: string, BytesReceived: number, BytesPaidFor: number, TotalPaid: string, TransferChannelID: ChannelID, DataTransfer: DataTransferChannel }
...
declare type RetrievalOrder = { Root: Cid, Piece: Cid, Size: number, LocalStore: number, Total: string, UnsealPrice: string, PaymentInterval: number, PaymentIntervalIncrease: number, Client: string, Miner: string, MinerPeer: RetrievalPeer }
...
declare class LotusRPC {
   ...
   */
  msigCancel (address: string, uint: number, address1: string, bigInt: string, address2: string, uint1: number, bytes: string): Promise<MessagePrototype>
  /**
  ...
  computeProof (sectorInfo: Array<SectorInfo>, uint: Array<number>): Promise<Array<PoStProof>>
